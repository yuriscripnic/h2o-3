...
public class TestUtil extends Iced {
   ...
   * @return
   */
  protected static Frame generate_enum_only(int numCols, int numRows, int num_factor) {
   ...
   * @return
   */
  protected static Frame generate_int_only(int numCols, int numRows, int iRange) {
    CreateFrame cf = new CreateFrame();
    cf.rows= numRows;
    cf.cols = numCols;
    cf.binary_fraction = 0;
